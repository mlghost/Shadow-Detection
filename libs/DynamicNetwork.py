...
class DynamicNet:
    ...
    def __init__(self, learning_rate=0.0001, BATCH_SIZE=10, activation_number=36, num_of_task=2):
        ...
        self.mask_path = '../data/ISTD_Dataset/augmented/train/train_B_224/'
        self.image_path = '../data/ISTD_Dataset/augmented/train/train_A_224/'
        self.test_image_path = '../data/ISTD_Dataset/augmented/test/test_A_224/'
        self.removed_path = '../data/ISTD_Dataset/augmented/train/train_C_224/'
        self.test_mask_path = '../data/ISTD_Dataset/augmented/test/test_B_224/'
        self.test_removed_path = '../data/ISTD_Dataset/augmented/test/test_C_224/'
